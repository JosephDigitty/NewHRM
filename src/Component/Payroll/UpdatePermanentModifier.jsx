...
import { permanentModifyers } from "../../utils/PayrollHelpers";
...
const UpdatePermanentSalaryModifiers = ({ payDate, isOpen, onClose, id }) => {
  ...
  useEffect(() => {
    const fetchSalaryModifiers = async () => {
      const result = await permanentModifyers(id);
      if (result) {
        setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.put(`/employee/payroll/permanent/edit/${id}`,{ id, allowances, deductions, payDate },);
      console.log("Payload sent", allowances, deductions, id)
      if (response.data.success) {
        showSuccess("Salary Modifiers updated successfully");
        onClose();
      }
    } catch (error) {
...
export default UpdatePermanentSalaryModifiers;
