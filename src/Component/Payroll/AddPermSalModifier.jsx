...
const AddPermanentSalaryModifiers = ({ isOpen, onClose, id }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(`/employee/payroll/permenent`,{ id, allowances, deductions });
      if (response.data.success) {
        showSuccess("Salary Modifiers added successfully");
        onClose();
      }
    } catch (error) {
...
export default AddPermanentSalaryModifiers;
